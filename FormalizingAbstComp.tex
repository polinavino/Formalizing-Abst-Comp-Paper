...
\indent {\tt \small Class {\bfseries RestrictionComb} (C : Category) : Type := \\
	\indent \{ \\ 
	\indent \indent   rc : forall a b : C, Hom a b -> Hom a a ; \\
	\indent \indent  rc1             : forall (a b : Obj), forall (f : Hom a b), f $\circ$ (rc a b f) = f ; \\
	\indent \indent  rc2 : forall (a b c: Obj), forall (f : Hom a b) (g : Hom a c), \\
	\indent \indent ... \\ 
	\indent \}.}
